...
impl Rsvp for ReservationManager {
    async fn reserve(&self, mut rsvp: abi::Reservation) -> Result<abi::Reservation, abi::Error> {
        ...
        let id: Uuid = sqlx::query(
            "INSERT INTO rsvp.reservations (user_id, resource_id, timespan, note, status) VALUES
            ($1, $2, $3, $4, $5::rsvp.reservation_status) RETURNING id",
        )
...
mod tests {
    ...
    //         "aliceid",
    //         "ocean-view-room-713",
    //         "2023-08-16T15:00:00-0700".parse().unwrap(),
    //         "2023-08-30T15:00:00-0700".parse().unwrap(),
    //         "hello.",
    //     );
